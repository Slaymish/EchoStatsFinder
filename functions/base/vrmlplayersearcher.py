...
class VRMLMain():
    ...
    def outputResults(self):
        ...
        if self.found_team != None:
            ...
            extraInfo = [team_info['rank'], team_info['gp'], team_info['w'], team_info['t'], team_info['l'], team_info['pts'], team_info['mmr'], team_info['region'], team_info['isRecruiting']]
            try:
            ...
            return team_name, ranking, tier, extraInfo
